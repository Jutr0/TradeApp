...
exports.addCharacter = (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const query = { characterId: req.body.characterId };
    const update = req.body;
    const options = { upsert: true, new: true };
    try {
        const character = yield models_1.Character.findOneAndUpdate(query, update, options)
            .lean()
            .exec();
        res.send(character);
    }
